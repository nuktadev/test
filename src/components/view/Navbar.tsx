    ...
    >
      ...
      >
        <div className="flex justify-center items-center flex-col">
          ...
          <Link
            href={"#"}
            className="flex w-40 items-center justify-center  rounded-md  bg-main px-7 py-2 text-base font-medium text-white shadow-sm hover:bg-grayBlack duration-300 "
          >
            Login
          </Link>
        </div>
